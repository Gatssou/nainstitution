...
<html lang="fr">
   ...
   <nav>
      ...
      <body>
         ...
         <h1>Profil de votre compte : <?php echo $_SESSION['user'];?> </h1>


         <!-- Changement d'information de la base de donnée pour l'utilisateur sauf le token ex = nom,email,mot de passe -->
